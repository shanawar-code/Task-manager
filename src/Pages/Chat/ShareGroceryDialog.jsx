...
function ShareGroceryDialog({ show, onClose }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-white bg-opacity-30 z-50">
      <div ref={popupRef} className=" mx-auto p-5 scroll-smooth bg-white shadow-lg border rounded-xl">
        <div>
        <div className="flex items-center justify-center">
          <h1 className="text-2xl font-semibold font-public-sans text-gray-1">Share Grocery dashboard</h1>  
        </div>
        <div className=" relative mt-[48px]">
            <Input label={'Sharing link'} value={'Grocerydashobard232Wlfgewe45dgfdsk'}/>
            <span onClick={handleShowPopup} className=" cursor-pointer absolute top-10 right-4"><Svgs.CopyIcon/></span>
        ...
        <div className="flex items-center justify-center gap-4 mt-[48px]">
            <button className=" text-base font-bold font-mulish text-gray-2 flex items-center gap-[6px] px-[14.5px] py-[11px] rounded-xl border border-gray-2">

...
//               </div>
//               <div>
//                 <Input label={'Title'} className={''}/>
//               </div>
//               <div className="flex w-full items-center flex-wrap md:flex-nowrap gap-5 relative">
//                 <Input label={'Date'} className={'w-screen lg:w-[400px]'}/>
//                 <img onClick={handleShowDialog} src='images/calendar.png' alt="" className=" absolute right-[53%] top-10" />
//                 <Input label={'Select time'} className={'w-screen lg:w-[400px]'}/>
...
function VerifiedSuccessful({ show, onClose }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div ref={popupRef} className="">
        <form onSubmit={handleSubmit}>
          <div className="mx-auto p-5 scroll-smooth bg-white shadow-lg rounded-xl border w-full">
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-center text-center">
              ...
              <div className="flex flex-wrap md:flex-nowrap items-center gap-5 relative">
                <Input label={"Date"} className={"w-max lg:w-[400px]"} />
                <img
                  onClick={handleShowDialog}
                  src="images/calendar.png"
                  alt="Calendar"
                  className="absolute md:right-[25%] lg:right-[53%] right-4 top-[38px] cursor-pointer"
                />
                <Input
                  label={"Select time"}

          ...
          <div className="upersection grid grid-cols-12">
            ...
            <div className="leftdownsection col-span-12 md:col-span-4 md:border-r  border-gray-5">
              ...
              {message.map((value,index)=>{
                return(
              <div key={index} className={`leftdown p-3 flex justify-between items-center w-full ${value.bg}  ${value.right} ${value.bottom} border-gray-5`}>
                <div onClick={()=>{navigate('/user/chat-dialog')}} className="flex items-center gap-[10px] w-full ">
                  <div className="">

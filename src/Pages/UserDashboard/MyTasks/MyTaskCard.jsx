    ...
    <div className='flex items-center justify-center sm:justify-start flex-wrap xl:flex-nowrap gap-4  scrollbar-none overflow-x-scroll '>
       ...
       {popupCardIndex === index && showPopup && <GroceryDialog show={showPopup} onClose={handleClosePopup} />}
        ...
        <div className=' sticky bottom-6 flex items-center justify-center'>
            <button onClick={handleShowPopup} className='flex items-center justify-center gap-[14px] px-[16px] py-[12px] w-[258px] border-[1px] border-[#fb6d72] border-dashed rounded-xl text-sm font-semibold font-public-sans bg-btn-gradient text-transparent bg-clip-text'><Svgs.AddIconRed/>Add New Task</button>
            {showPopup && (
                <CreateTaskDialog
                  show={showPopup}
